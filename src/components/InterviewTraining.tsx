...
export const InterviewTraining = ({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      {step === 'intro' && (
        <AnimatedStep stepKey="intro" className="text-center space-y-6 py-12">
      ...
      {step === 'about' && (
        <AnimatedStep stepKey="about" className="space-y-6">
      ...
      {step === 'experiences' && (
        <AnimatedStep stepKey="experiences" className="space-y-6">
          <div className="text-center space-y-2">
            <div className="w-14 h-14 mx-auto rounded-2xl bg-primary/10 flex items-center justify-center">
